...
int main() {
    std::cout << "Анализ сорнякового метода оптимизации" << std::endl;
    std::cout << "=================================================" << std::endl;
    std::cout << "\nАнализ на функции Сферы (2D, минимум в [0,0])" << std::endl;
    ...
    std::cout << "\nАнализ на функции Сферы (5D, минимум в [0,0,0,0,0])" << std::endl;
    std::cout << std::setw(30) << std::left << "Метод" 
              << std::setw(15) << "Ошибка" 
              << std::setw(15) << "Время (мс)" 
              << std::setw(12) << "Итерации" << std::endl;
    ...
    std::cout << "\nАнализ на функции Розенброка (4D, минимум в [1,1,1,1])" << std::endl;
    std::cout << std::setw(30) << std::left << "Метод" 
              << std::setw(15) << "Ошибка" 
              << std::setw(15) << "Время (мс)" 
              << std::setw(12) << "Итерации" << std::endl;
