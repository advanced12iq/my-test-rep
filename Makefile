...
all: sornyak comparison conventional_comparison detailed_analysis
...
.PHONY: all sornyak comparison conventional_comparison detailed_analysis run run_comparison run_conventional_comparison run_detailed_analysis run_sornyak_optimization clean clean_all